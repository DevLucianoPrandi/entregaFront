...
const Idioma2 = new Lenguas(2, "Alemán", "Un idioma que abre muchas purtas laborales y culturales.", "Ich möchte diese Sprache lernen!", "Alemania, Austria, Suiza, Principado de Liechtenstein", DeuFlag);
                ...
                <Col xs={12} md={6} lg={8}>
                    <Card className='shadow text-center mx-auto'>
                        <Card.Body className='text-center mx-auto'>
                            ...
                            <Button style={{ width: '12em', marginTop: '0.5em' }} variant="outline-primary" as={Link} to="../contacto">Aquí</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
