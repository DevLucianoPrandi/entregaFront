    ...
    <Container fluid className='tablas p-4 w-100'>
      <Row >
        ...
        <Col xs={12} md={12} lg={6} className='my-auto'>
          <h2 span style={{ color: 'darkmagenta' }}>Taller de literatura</h2>
          <h5 style={{ textAlign: 'justify', color: 'orchid' }}>Aprender haciendo:</h5>
          <p className='w-100'>Los talleres de literatura de <span style={{ color: 'orchid' }}>Inter</span><span style={{ color: 'darkmagenta' }}>Lingua</span> apuntan a reforzar y mantener el nivel idiomático alcanzado por el alumno. Con encuentros semanales de 2 horas, donde se abordaran temáticas de discusión basadas en una serie determinada de libros propuesta por el docente, se abre un espacio de intercambio idiomático y de ideas a fines de poner en práctica los conocimientos adquiridos.
            <br />
            Muchos alumnos eligen complementar los cursos de idioma regulares o intensivos que ofrece <span style={{ color: 'orchid' }}>Inter</span><span style={{ color: 'darkmagenta' }}>Lingua</span> participando de estos talleres abiertos a todo el público con un determinado nivel de idioma, que le permita abordar los textos propuestos.
          </p>
        </Col>
        <Col sx={6} md={6} lg={3} className='my-auto'>
          <div>
