      ...
      <Row className='justify-content-center'>
        <Col xs={12} md={12} lg={6} >
          <div className='w-80 text-center'>
            <h2 span style={{ color: 'darkmagenta' }}>Talleres de conversación</h2>
            <h5 style={{ color: 'orchid' }}>Aprender hablando</h5>
            <p className="text-center mx-auto"><span style={{ color: 'orchid' }}>Inter</span><span style={{ color: 'darkmagenta' }}>Lingua</span> te ofrece la posibilidad de poner en práctica el idioma que estás aprendiendo. La propuesta apunta a tener encuentros semanales de 2 horas con otros alumnos de diferentes cursos que también quieran poner a prueba sus conocimientos.
              <br />
              Para conocer más sobre este y otros talleres que ofrece <span style={{ color: 'orchid' }}>Inter</span><span style={{ color: 'darkmagenta' }}>Lingua</span> para complementar o como alternativa a los cursos extensivos e intensivos, comunicate con nosotros y sacate todas las dudas.
            </p>
            <ListGroup>
