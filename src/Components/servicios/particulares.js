    ...
    <Container fluid className='tablas w-100 p-4'>
      ...
      <Row >
        <Col xs={12} md={12} lg={6} >
          <div className='my-4'>
            <h2 span style={{ color: 'darkmagenta' }}>Clases particulares</h2>
            <h5 style={{ textAlign: 'justify', color: 'orchid' }}>A tu medida:</h5>
            <p className='w-100'>En <span style={{ color: 'orchid' }}>Inter</span><span style={{ color: 'darkmagenta' }}>Lingua</span> podés reservar horas particulares que se ajusten a tu ritmo y tus necesidades. La posibilidad de reservar horas de clases individuales (válido para máximo 2 personas) apunta a ofrecer un espacio donde el alumno pueda trabajar sobre sus dudas y avanzar a su propio ritmo basado en necesidades específicas.
            <br />
            Para conocer más sobre esta modalidad que ofrece <span style={{ color: 'orchid' }}>Inter</span><span style={{ color: 'darkmagenta' }}>Lingua</span> como alternativa a los cursos extensivos e intensivos, comunicate con nosotros y sacate todas las dudas.
            </p>
