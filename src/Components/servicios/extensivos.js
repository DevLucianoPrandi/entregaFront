        ...
        <Container fluid className='tablas p-4 w-100'>
            <Row className='justify-content-center'>
                ...
                <Col xs={12} md={12} lg={6} className='text-center my-auto'>
                        <h2 span style={{ color: 'darkmagenta' }}>Cursos extensivos</h2>
                        <h5 span style={{ color: 'orchid' }}>Sin apuros</h5>
                        ...
                        <br />
                        Muchas personas prefieren ir a un ritmo regular de cursada, logrando avanzar un nivel por semestre, puediendo siempre complementar con cursos de conversación o formando parte de los talleres literarios que ofrece <span style={{ color: 'orchid' }}>Inter</span><span style={{ color: 'darkmagenta' }}>Lingua</span>
                        </p>
                </Col>
            </Row>
            <Row>
